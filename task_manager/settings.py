...
SECRET_KEY = 'django-insecure-he8#x@wu(!b(4qumu3h2=yt3%3#$4slzl^x1^rgc(w!jug#kr!'
...
DATABASES = {
    ...
    'test': {
        'NAME': f"test_{env('DB_NAME', default='test_db')}",
    }
}
...
# Email settings (example configuration, adjust as needed)
